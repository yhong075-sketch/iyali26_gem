...
def legacy_main():
    """Retired compatibility entry point forwarding to the unified builder."""

    return _load_unified_main()()


def main():
    """Compatibility entry point forwarding to the single supported builder."""
    return legacy_main()


if __name__ == "__main__":
    if "--resolve-entry-smoke" in sys.argv:
        _load_unified_main()
        print("update_model entry resolution: OK")
    else:
        main()
